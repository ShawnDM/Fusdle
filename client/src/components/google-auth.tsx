...
import { LogOut, Trophy, BarChart3, Calendar, Shield, X } from "lucide-react";
...
export const GoogleAuth: React.FC<GoogleAuthProps> = ({ showBenefits = true, compact = false, asPopup = false, open = false, onOpenChange }) => {
  ...
  // If using as popup, return dialog
  if (asPopup) {
    return (
  ...
  return (
    ...
    >
      <div className="border border-blue-200 bg-gradient-to-br from-blue-50 to-purple-50 rounded-lg p-6">
        {signInContent}
      </div>
    </motion.div>
  );
